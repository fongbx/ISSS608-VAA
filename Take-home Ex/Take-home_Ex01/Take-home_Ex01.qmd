...
ggplot(wage_col_overtime, aes(x = Amount, y = yearmonth)) +
...
test <- financial_yearmth %>% 
  select(-CostOfLiving) %>% 
  pivot_longer(cols = c("Wage", "Education", "Food", "Recreation", "AdjustedShelter"),
               names_to = "Category",
               values_to = "Amount")

ggplot(test, aes(x = Amount, y = yearmonth, fill = Category)) +
