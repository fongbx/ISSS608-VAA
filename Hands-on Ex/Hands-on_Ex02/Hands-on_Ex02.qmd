...
In this exercise, besides tidyverse, four other R packages will be used. They are:
...
```{r}
pacman:: p_load(tidyverse, ggrepel, ggthemes, hrbrthemes, patchwork, cowplot, gridExtra)
```
